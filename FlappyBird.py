...
IMAGEM_CHAO = pygame.transforme.sacle2x(pygame.imagem.load(os.path.join('imags','base.png')))
...
class Cano:
    ...
    def __init__(self, x):
        ...
        self.pos_topo = 0
        self.pos_base = 0
        self.CANO_TOPO =  pygame.transforme.flip(IMAGEM_CANO, False, True)
